  ...
  return(
    <div style={{marginBottom:12}}>
      ...
      {todayMatches.map(function(m){
        ...
        var isFinished=realSc&&locked
        var bg=isFinished?(pts===2?'#eafff0':pts===1?'#fff8e1':pts===0?'#ffeaea':'#fafafa'):'#fff'
        var borderCol=isFinished?(pts===2?C.green:pts===1?C.gold:pts===0?C.red:C.border):locked?C.border:C.blue
        return(
            ...
            <div style={{display:'flex',alignItems:'center',gap:8}}>
              ...
              {realSc?(
                <div style={{textAlign:'center',minWidth:70}}>
                  <div style={{fontSize:22,fontWeight:700,color:C.blue}}>{realSc.a} - {realSc.b}</div>
                  <div style={{fontSize:10,color:C.gray}}>resultado real</div>
                </div>
              ):(
